...
- **Swagger**: https://server-validation-cep-mepu6h3qaa-uc.a.run.app/docs/index.html

- **Exemplo de requisição**:
  ```http
  GET https://server-validation-cep-mepu6h3qaa-uc.a.run.app/weather?cep=01001000 HTTP/1.1
  ```
